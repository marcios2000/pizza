  ...
  class Orders extends React.Component {
      ...
      componentDidMount(){
          axios.get(url).then( response => {
              this.setState({name: response.data, items_purchased: response.data, total: response.data})
          })
    ...
    render() {
      ...
      return ( 
      <div>
        <BootstrapTable data={data } cellEdit={ cellEditProp } insertRow exportCSV selectRow={ selectRow }
        deleteRow
         >
