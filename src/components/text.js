...
const cellEditProp = {
  ...
  class DbClickToSelectTable extends React.Component {
    ...
    render() {
      ...
      return ( 
      <div>
        <BootstrapTable data={foodItems } cellEdit={ cellEditProp } insertRow exportCSV selectRow={ selectRow }
        deleteRow
         >
            <TableHeaderColumn dataField='product_id' >Product ID</TableHeaderColumn>
